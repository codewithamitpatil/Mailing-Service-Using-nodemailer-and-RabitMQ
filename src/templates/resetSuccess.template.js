const resetpassSuccessTemp = async (data) => {
    const {
        product,
        uname
    } = data;
                                ...
                                <tr>
                                    <td style="padding:0 35px;">
                                        ...
                                        <p style="font-size: 17px;text-align: left;color:#1e1e2d61;;">
                                            ${ product } will inform you that your password has been successfully updated
                                            ,
                                            now you can signin with new password.
                                        </p>
...
module.exports = resetpassSuccessTemp;