const accountVerifySuccessTemp = async (data) => {
    const {
        product,
        uname
    } = data;
...
<head>
    ...
    <title>Account Verified Success Email Template</title>
                                ...
                                <tr>
                                    <td style="padding:0 35px;">
                                        ...
                                        <p style="font-size: 17px;text-align: left;color:#1e1e2d61;;">
                                            ${ product } will inform you that your account has been successfully verified
                                            ,
                                            now you can signin .
                                        </p>
                                        ...
                                        <p style="font-size: 17px;text-align: left;color:#1e1e2d61;;">
                                            ...
                                            please reply to this email. We always happy to help!
                                        </p>
...
module.exports = accountVerifySuccessTemp;