const verificationTemp = async (data) => {
    const {
        link,
        uname
    } = data;
                                ...
                                <tr>
                                    <td style="padding:0 35px;">
                                        <h1
                                            ...
                                            Email Address Confirmation</h1>

                                        <span
                                            style="display:inline-block; vertical-align:middle; margin:29px 0 26px; border-bottom:1px solid #cecece; width:100px;"></span>
                                        <h4 style="text-align: left;color:#1e1e2d61;">Hi,&nbsp;&nbsp;${ uname }</h4>
                                        <p
                                            style="text-align: left;color:#455056; font-size:15px;line-height:24px; margin:0;">
                                            Click the button below to complete your Socials account registration.
